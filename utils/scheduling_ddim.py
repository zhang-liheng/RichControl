# Copyright 2025 Peking University Team, Stanford University Team and The HuggingFace Team. All rights reserved.
# Modified from https://github.com/Newbeeer/diffusion_restart_sampling/
#
...
class RichControlDDIMSchedulerOutput(DDIMSchedulerOutput):
    """
...
class RichControlDDIMScheduler(DDIMScheduler):
    ...
    def step(
        ...
        alpha_prod_t_prev = self.alphas_cumprod[self.timesteps[timestep_idx + 1].cpu().numpy()] if timestep_idx + 1 < len(self.timesteps) else self.final_alpha_cumprod
        ...
        return RichControlDDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample)
